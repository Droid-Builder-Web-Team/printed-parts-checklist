            ...
            <div class="tab-content__tab-items">
              ...
              <div class="hidden p-4 bg-white rounded-lg dark:bg-gray-800 tab-content__tab_contents">
                ...
                <div class="relative z-0 w-full mb-6 group">
                  <select id="type" name="type"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                    <option disabled selected="selected">Select The Droid Type</option>
                ...
                <div class="relative z-0 w-full mb-6 group">
                  <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300" for="user_avatar">Upload Droid Avatar</label>
                  <input
              ...
              <div class="hidden p-4 bg-gray-50 rounded-lg dark:bg-gray-800 tab-content__tab_contents">
                <div class="relative z-0 w-full mb-6 group">
                  ...
                  <input
                    class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                    id="bill_of_materials" type="file">
                </div>
              </div>
