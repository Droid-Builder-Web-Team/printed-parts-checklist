...
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'swiper/bundle'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'swiper/css/bundle'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
if (document.querySelectorAll(".droid-slider").length > 0) {
  new Object(function webpackMissingModule() { var e = new Error("Cannot find module 'swiper/bundle'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(".droid-slider", {
    slidesPerView: 1,
    spaceBetween: 40,
    breakpoints: {
      0: {
